/* linux/arch/arm/mach-s5p6442/map-base.h
 *
...
#define S3C_VA_DRAMC        S3C_ADDR(0x01804000)    /* DRAM Controller */
...
#define S5P64XX_PA_ONENAND      (0xB0000000)
#define S5P64XX_SZ_ONENAND      SZ_128K
#define S5P64XX_VA_ONENAND      S3C_VA_ONENAND
#define S5P64XX_PA_ONENAND_DMA  (0xB0600000)
#define S5P64XX_SZ_ONENAND_DMA  SZ_8K
